    ...
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            if (cfg.lang == "id")
            {
                ...
                label15.Text = langID.main.label_profile;
            }
            else
            {
                ...
                label15.Text = langEN.main.label_profile;
            }
        }
        ...
        private void button1_Click(object sender, EventArgs e) //deposit saldo
        {
            ...
            //calculate
            var newPemasukan = pemasukan + inputDeposit;
            var newSaldo = Convert.ToString(saldo + inputDeposit);
            //update saldo
        ...
        private void button2_Click(object sender, EventArgs e) //withdraw saldo
        {
            ...
            //calculate
            var newPengeluaran = pengeluaran + inputWithdraw;
            var newSaldo = Convert.ToString(saldo - inputWithdraw);
            //update saldo
            pengguna.setSaldo(loginedUser, newSaldo);
            //update pengeluaran
